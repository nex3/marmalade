...
function extensions(app) {
    return function(req, res, next) {
        ...
        /**
         * Extend res.render so that the username is passed as a local to the view.
         */
            ...
            step(
                  function() {
                      if (!req.session.username || !req.session.userToken) {
                          throw new base.HttpError('Must be logged in', 400);
                      }
